...
after doing so, run the following command to install all the requirements we use for this specific project: **pip install -r requirements.txt**. The .txt file is available for you to see what dependencies and versions were necesarry to build this project. 
